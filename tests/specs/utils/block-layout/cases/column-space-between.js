...
describe('Layout Case : {flexDirection:"column", justifyContent:"space-between"}', function () {
	...
	it("First child should snap on container top minus its margin", function () {

		child1BB.set({marginTop: 0.1});
		child1CB.set({marginTop: 0.1});
	...
	it("Last child should snap on container bottom minus its margin", function () {

		child5BB.set({marginBottom: 0.1});
		child5CB.set({marginBottom: 0.1});
