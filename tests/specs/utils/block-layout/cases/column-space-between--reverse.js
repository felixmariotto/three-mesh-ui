...
describe('Layout Case : {flexDirection:"column-reverse", justifyContent:"space-between"}', function () {
	...
	beforeEach( function () {
		...
		containerBB.set({flexDirection: 'column-reverse', justifyContent:'space-between'});
		containerCB.set({flexDirection: 'column-reverse', justifyContent:'space-between'});
