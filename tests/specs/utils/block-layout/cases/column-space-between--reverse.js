...
describe('Layout Case : {contentDirection:"column-reverse", justifyContent:"space-between"}', function () {
	...
	beforeEach( function () {
		...
		containerBB.set({contentDirection: 'column-reverse', justifyContent:'space-between'});
		containerCB.set({contentDirection: 'column-reverse', justifyContent:'space-between'});
	...
	it("Last child should snap on container top", function () {
	...
	it("Last child should snap on container top minus its margin", function () {

		child5BB.set({marginTop: 0.1});
		child5CB.set({marginTop: 0.1});
	...
	it("First child should snap on container bottom", function () {
	...
	it("First child should snap on container bottom minus its margin", function () {

		child1BB.set({marginBottom: 0.1});
		child1CB.set({marginBottom: 0.1});
