...
describe('Layout Case : {contentDirection:"row-reverse", justifyContent:"start"}', function () {
	...
	beforeEach( function () {
		...
		containerBB.set({contentDirection: 'row-reverse', justifyContent:'start'});
		containerCB.set({contentDirection: 'row-reverse', justifyContent:'start'});
	...
	it("First child should snap on right on container", function () {
		...
		expect( imprecise( child1BB.position.x) ).equals( containerRightBB - child1BB.offsetWidth / 2 );
		expect( imprecise( child1CB.position.x) ).equals( containerRightCB - child1CB.offsetWidth / 2 );
	});
	...
	it("First child should snap on right on container minus margin", function () {
		...
		expect( imprecise( child1BB.position.x) ).equals( containerRightBB - child1BB.offsetWidth / 2 - child1BB._margin.y);
		expect( imprecise( child1CB.position.x) ).equals( containerRightCB - child1CB.offsetWidth / 2 - child1CB._margin.y);
	});
