...
describe('Layout Case : {flexDirection:"row-reverse", justifyContent:"start"}', function () {
	...
	beforeEach( function () {
		...
		containerBB.set({flexDirection: 'row-reverse', justifyContent:'start'});
		containerCB.set({flexDirection: 'row-reverse', justifyContent:'start'});
	...
	it("First child should snap on right on container", function () {
		...
		expect( imprecise( child1BB.position.x) ).equals( containerRightBB - child1BB._bounds._offsetWidth / 2 );
		expect( imprecise( child1CB.position.x) ).equals( containerRightCB - child1CB._bounds._offsetWidth / 2 );
	});

	it("First child should snap on right on container minus margin", function () {
		...
		expect( imprecise( child1BB.position.x) ).equals( containerRightBB - child1BB._bounds._offsetWidth / 2 - child1BB._margin._value.y);
		expect( imprecise( child1CB.position.x) ).equals( containerRightCB - child1CB._bounds._offsetWidth / 2 - child1CB._margin._value.y);
	});
