...
describe('Layout Case : {contentDirection:"row-reverse", justifyContent:"end"}', function () {
	...
	beforeEach( function () {
		...
		containerBB.set({contentDirection: 'row-reverse', justifyContent:'end'});
		containerCB.set({contentDirection: 'row-reverse', justifyContent:'end'});
	...
	it("Last child should snap on left on container", function () {
		...
		expect( imprecise( child5BB.position.x) ).equals( containerLeftBB + child5BB.offsetWidth / 2 );
		expect( imprecise( child5CB.position.x) ).equals( containerLeftCB + child5CB.offsetWidth / 2 );
	});
	...
	it("Last child should snap on left on container minus margin", function () {
		...
		expect( imprecise( child5BB.position.x) ).equals( containerLeftBB + child5BB.offsetWidth / 2 + child5BB._margin.w);
		expect( imprecise( child5CB.position.x) ).equals( containerLeftCB + child5CB.offsetWidth / 2 + child5CB._margin.w);
	});
