...
describe('Layout Case : {flexDirection:"row-reverse", justifyContent:"end"}', function () {
	...
	beforeEach( function () {
		...
		containerBB.set({flexDirection: 'row-reverse', justifyContent:'end'});
		containerCB.set({flexDirection: 'row-reverse', justifyContent:'end'});
	...
	it("Last child should snap on left on container", function () {
		...
		expect( imprecise( child5BB.position.x) ).equals( containerLeftBB + child5BB._bounds._offsetWidth / 2 );
		expect( imprecise( child5CB.position.x) ).equals( containerLeftCB + child5CB._bounds._offsetWidth / 2 );
	});

	it("Last child should snap on left on container minus margin", function () {
		...
		expect( imprecise( child5BB.position.x) ).equals( containerLeftBB + child5BB._bounds._offsetWidth / 2 + child5BB._margin._value.w);
		expect( imprecise( child5CB.position.x) ).equals( containerLeftCB + child5CB._bounds._offsetWidth / 2 + child5CB._margin._value.w);
	});
