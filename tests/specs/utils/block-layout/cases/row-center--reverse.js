...
describe('Layout Case : {contentDirection:"row-reverse", justifyContent:"center"}', function () {
	...
	beforeEach( function () {
		...
		containerBB.set({contentDirection: 'row-reverse', justifyContent:'center'});
		containerCB.set({contentDirection: 'row-reverse', justifyContent:'center'});
