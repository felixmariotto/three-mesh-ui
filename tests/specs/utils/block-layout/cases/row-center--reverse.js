...
describe('Layout Case : {flexDirection:"row-reverse", justifyContent:"center"}', function () {
	...
	beforeEach( function () {
		...
		containerBB.set({flexDirection: 'row-reverse', justifyContent:'center'});
		containerCB.set({flexDirection: 'row-reverse', justifyContent:'center'});
