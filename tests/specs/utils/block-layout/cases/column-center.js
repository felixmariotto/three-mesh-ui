...
describe('Layout Case : {contentDirection:"column", justifyContent:"center"}', function () {
	...
	beforeEach( function () {
		...
		containerBB.set({contentDirection: 'column', justifyContent:'center'});
		containerCB.set({contentDirection: 'column', justifyContent:'center'});
