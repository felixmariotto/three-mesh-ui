...
describe('Layout Case : {flexDirection:"column", justifyContent:"center"}', function () {
	...
	beforeEach( function () {
		...
		containerBB.set({flexDirection: 'column', justifyContent:'center'});
		containerCB.set({flexDirection: 'column', justifyContent:'center'});
