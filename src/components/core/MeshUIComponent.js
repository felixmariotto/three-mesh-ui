...
export default class MeshUIComponent extends Object3D {
	...
	constructor( options ) {
		 ...
		 * @private
		 */
		this._borderRadiusComponent = new BorderRadius( this._borderRadius );
		 ...
		 * @private
		 */
		this._borderWidthComponent = new BorderWidth( DEFAULTS.borderWidth );
			...
			if ( this[ prop ] != options[ prop ] ) {
				...
				switch ( prop ) {
					...
					case 'textType' :
						...
						// Temp until styles - Inline + Computed => Output
	 ...
	 * @returns {string}
	 */
	get borderRadiusUnits() { return this._borderRadiusComponent.units; }
	 ...
	 * @returns {number}
	 */
	get borderTopLeftRadius() { return this._borderWidth.x; }
	 ...
	 * @returns {number}
	 */
	get borderTopRightRadius() { return this._borderWidth.y; }
	 ...
	 * @returns {number}
	 */
	get borderBottomRightRadius() { return this._borderWidth.z; }
	 ...
	 * @returns {number}
	 */
	get borderBottomLeftRadius() { return this._borderWidth.w; }
	 ...
	 * @returns {number}
	 */
	get borderTopRadius() { return this._borderWidth.y; }
	 ...
	 * @returns {number}
	 */
	get borderRightRadius() { return this._borderWidth.z; }
	 ...
	 * @returns {number}
	 */
	get borderLeftRadius() { return this._borderWidth.x; }
	 ...
	 * @returns {number}
	 */
	get borderBottomRadius() { return this._borderWidth.w; }
	 ...
	 * @returns {string}
	 */
	get borderWidthUnits() { return this._borderWidthComponent.units; }
	 ...
	 * @returns {number}
	 */
	get borderTopWidth() { return this._borderWidth.x; }
	 ...
	 * @returns {number}
	 */
	get borderRightWidth() { return this._borderWidth.y; }
	 ...
	 * @returns {number}
	 */
	get borderBottomWidth() { return this._borderWidth.z; }
	 ...
	 * @returns {number}
	 */
	get borderLeftWidth() { return this._borderWidth.w; }
