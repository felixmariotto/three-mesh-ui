...
const pages = [
	...
	[ 'tut__basic_setup_7xx', 'Basic setup 7xx' ],
...
const webpackConfig = env => {
	...
	const config = {
		...
		entry: {
			...
			api__order: './examples/api__order.js',
			tut__basic_setup: './examples/tut__basic_setup.js',
			tut__basic_setup_7xx: './examples/tut__basic_setup_7xx.js',
			...
			tut__sizes: './examples/tut__sizes.js',
